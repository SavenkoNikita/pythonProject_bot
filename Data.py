...
sheets_file = {
    'Дежурный': 'Дежурный',
    'Инвертаризация': 'Инвентаризация',
    'Уведомления для подписчиков': 'Уведомления для подписчиков',
    'Уведомления для всех': 'Уведомления для всех',
    'Уведомления для админов': 'Уведомления для админов'
}
