...
way = '192.168.0.236/public_files/14_Отдел_ИТ/1_Личные_папки/Савенко_Никита/Документы/Графики дежурств.xlsx'
route = 'smb://' + host_name + ':' + pass_log_in + '@' + way

# Листы в файле
sheets_file = {
    'Дежурный': 'Субботний дежурный(Python)',
    'Инвертаризация': 'Инвентаризация(Python)',
    'Уведомления': 'Уведомления(Python)'
}
