from src.Body_bot import Telegram_bot
from src.Body_bot.Secret import bot3 as bot
...
class Callback_button:
    ...
    def __init__(self, header_menu, value_button, user_id, object_data):
        ...
        # print(object_data)
        self.message = self.object_data.message
    ...
    def menu_processing(self, message_id):
        ...
        ###
        list_buttons = []
        if self.value_button in list_buttons:
            print('generate menu')
        ###
